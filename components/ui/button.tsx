...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-full text-sm font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-soft hover:-translate-y-0.5 hover:bg-primary/95 hover:shadow-card",
        secondary:
          "surface-pill border border-white/80 text-secondary-foreground hover:bg-white hover:text-slate-900",
        ghost: "text-slate-500 hover:bg-white/90 hover:text-slate-900"
      },
      size: {
